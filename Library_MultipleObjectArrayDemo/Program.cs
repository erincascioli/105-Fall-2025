namespace Library_MultipleObjectArrayDemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Book bartendingBook = new Book("Bartending for dummies", "Erin", 374);
            defaultBook.Print();
            bartendingBook.Print();
            ...
            bartendingBook.ReadBook(userWantsToReadThisNumberOfPages);
            bartendingBook.Print();

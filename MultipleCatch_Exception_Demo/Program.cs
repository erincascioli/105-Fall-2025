    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            catch (ArgumentNullException error)
            {
                ...
                //   object ex.
                Console.WriteLine("Null Error: " + error.Message);
            }
            ...
            {
                Console.WriteLine("Out of range Error: " + error.Message);
            }
            ...
            manager.AddPlayer("Dave");
            manager.AddPlayer("Ryan");
            manager.AddPlayer("Shaggy");
            manager.AddPlayer("Velma");
            manager.AddPlayer("Daphne");
            ...
            try
            {
                Player bob = manager.GetPlayerByName("Bob");             // FINE
                Player unknown = manager.GetPlayerByName("Urglgru");     // OOPS
                Player ryan = manager.GetPlayerByName("Ryan");           // FINE
            }
            catch(Exception error)
            {
                Console.WriteLine("Error detected! " + error.Message);
            }
